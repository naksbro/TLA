...
public class AssignmentTest {
	...
	public void squirrelPlay() {
		...
		assertEquals(obj.squirrelPlay(95, true), true);
	...
	public void checkBob() {
		...
		assertEquals(obj.checkBob("asdfdsfBobfsdfsaf"), "You got it Bob!");
	}
	...
	public void fahrenheitToCelsius() {
		assertEquals(obj.fahrenheitToCelsius(95.0), 35.0, 0);
		assertEquals(obj.fahrenheitToCelsius(50.0), 10.0, 0);
	}
}
